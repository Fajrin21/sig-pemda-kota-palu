...
<body>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between" style="height: 70px;">

      <a href="index.html" class="logo d-flex align-items-center">
        <!-- Uncomment the line below if you also wish to use an image logo -->
         <img src="admin/img/palu.png" style="max-height: 70px;" alt="" title=""> 
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="data_wisata.php">Data Pertanahan</a></li>
          <li><a class="get-a-quote" href="admin/login.php">Login Admin</a></li>
        </ul>
      </nav><!-- .navbar -->
  ...
  <section id="hero" class="hero d-flex align-items-center">
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between" style="margin-top: 28px;">
        <div class="col-lg-7 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Sistem Informasi Geografis</h2>
          <h3 data-aos="fade-up" data-aos-delay="100">Pemetaan Tanah Pemda Kota Palu</h3>
        </div>
